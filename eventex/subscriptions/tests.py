...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        expect = ['contato@eventex.com.br', 'rafaelscnunes@gmail.com']
        self.assertEqual(expect, self.email.to)

    def test_subscrition_email_body(self):
        self.assertIn('Rafael Nunes', self.email.body)
        self.assertIn('12345678901', self.email.body)
        self.assertIn('rafaelscnunes@gmail.com', self.email.body)
        self.assertIn('21981246171', self.email.body)
